...

{
  ...
  "people_mentioned": ["only specific, identifiable INDIVIDUALS — a person's name, or a singular role pointing to one identifiable person (e.g. \"Ethan's class teacher\"). EXCLUDE generic groups or plurals (\"parents\", \"families\", \"class teachers\"), organizations/teams/units and their acronyms (e.g. \"AR\", \"JOC\", \"law enforcement\"), pronouns or vague references (\"the client\", \"her\"), and terms of endearment / pet names used in place of a name (\"pookie\", \"babe\", \"love\", \"hun\"). Empty array if none."],
  "entities": {
...
- due: a calendar DATE only in ISO 8601 "YYYY-MM-DD" form (no time, no timezone, never "Z"/UTC). Include it whenever a date OR a relative timeframe is mentioned, resolving relative ones ("tomorrow", "tomorrow morning", "Friday", "next week") against the provided message reference date; use "" only when no timing at all is given.
